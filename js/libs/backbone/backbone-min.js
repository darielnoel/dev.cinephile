...
(function(h, g) {
                ...
                if (e = this._callbacks) {
                    ...
                    for (a = a ? a.split(q) : f.keys(e); d = a.shift();)
                        if (k = e[d], delete e[d], k && (b || c))
                            for (g = k.tail;
                                (k = k.next) !== g;)
                                if (j = k.callback, h = k.context, b && j !== b || c && h !== c) this.on(d, j, h);
                    return this
                }
            },
            trigger: function(a) {
    ...
    f.extend(o.prototype, l, {
        ...
        changedAttributes: function(a) {
            if (!a) return this.hasChanged() ? f.clone(this.changed) :
                false;
            var b, c = false,
    ...
    f.extend(m.prototype, l, {
        ...
        start: function(a) {
            ...
            if (this._wantsHashChange && this._wantsPushState && !this._hasPushState && !b) return this.fragment = this.getFragment(null, true), window.location.replace(this.options.root + "#" + this.fragment), true;
                ...
                b && a.hash) this.fragment = this.getHash().replace(s, ""), window.history.replaceState({}, document.title, a.protocol + "//" + a.host + this.options.root + this.fragment);
